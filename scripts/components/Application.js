	...
	componentDidMount() {
		...
		if (window.eventBus) {
			window.eventBus.dispatch('application.searchParams', {
				...
				searchBirthYears: this.props.params.birth_years,
	...
	componentWillReceiveProps(props) {
		...
		if (window.eventBus) {
			eventBus.dispatch('application.searchParams', {
				...
				searchBirthYears: props.params.birth_years,
	...
	render() {
		...
		return (
			<div className={'app-container'+(this.state.popupVisible ? ' has-overlay' : '')}>
				...
				<MapView searchParams={this.state.params} onMarkerClick={this.mapMarkerClick} disableHeatmapMode={true}>
